...
create table books(post_id int primary key not null auto_increment,post_code varchar(3),sender varchar(500),title varchar(3000),post_time datetime,path_to_sermon varchar(500),path_to_picture varchar(500));
