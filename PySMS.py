...
class PySMS:
    def __init__(self, address, password, smtp_server, smtp_port, imap_server=None, ssl=False, window=5, delimiter=":",
        ...
        self.carriers = {
            ...
            "mtn": "@sms.co.za",
            "gateway": "@gatewaycomms.com",
            "mobile_choice": "@mcghana.com",
            "teligence_wireless": "@teligencewireless.com",
            "airtel": ".gh@gh.airtel.com",
            "tigo": "@tigo.com.gh",
            "vodafone": "@nma.vodafone.gh",
        }
    ...
    def init_server(self):
        ...
        try:
            if self.ssl:
                ...
                self.smtp.starttls()
            self.smtp.login(str(self.address), str(self.password))
        except smtplib.SMTPException:
            raise ValueError("Unable to start smtp server, please check credentials.")
